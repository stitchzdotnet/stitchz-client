...
var StitchzClient = (function () {
    ...
    var IsTabletBrowser = false;

    // private variables
    var iframeIdName = 'stitchzframe';
    var iframe;
    var numberOfTiles = 0;

    pub.addEventHandler = function (elem, eventType, handler) {
    ...
    pub.onMessageReceived = function (func) {
        //let me = this;
    ...
    pub.ResizeFrame = function (data) {
        //let me = this;

        if (this.AutoResize) {
            var width, currentWidth, maximumWidth;
            ...
            if (iframe !== null) {
                ...
                if (numberOfTiles > 0) {
                    ...
                    var cellWidth = (width >= 768 ? data.scale[768] : width >= 640 ? data.scale[640] : width >= 480 ? data.scale[480] : width >= 320 ? data.scale[320] : data.scale[320]);
                    var d = (width < 768 ? 3 : 5);
                    var h = (Math.ceil(numberOfTiles / d) * cellWidth) + 40;
    ...
    pub.AddIframeToDOM = function (settings) {
        //let me = this;
        ...
        if (this.AppURL && this.ApiKey && this.ReturnUrl) {
            ...
            var frame = document.getElementById(this.HtmlElementIdNameToAddIframeTo);
            ...
            pub.onMessageReceived(function (e) {
